...
console.log("bubble highscore:" + highScore);
var bestSolutions = [];
for (var i=0; i<scores.length; i++){
    if(scores[i]==highScore){
...
console.log("solutions with the highscore :"+ bestSolutions);

function getFiftyBelowResults (scores){
    var results = [];
    for(var i=0; i<scores.length; i++){
        if(scores[i]<=50){
            results.push(i);
...
var results = getFiftyBelowResults (scores);
console.log("fifty below results:"+ results+ "numbers :"+scores[i]);
